...
namespace DevGate.Data.Tests.SpecificationTests
{
	...
	{
		[Test]
		public void Evaluate_GivenSingleMatchingSpecifications_ReturnsCombinationAsTrue()
		{
			// Arrange
			...
			var andSpecification = new OrSpecification<TestEntity>(mockLeftSpecification.Object, mockRightSpecification.Object);
		...
		[Test]
		public void Evaluate_GivenTwoMatchingSpecifications_ReturnsCombinationAsTrue()
		{
			// Arrange
			var mockLeftSpecification = new Mock<Specification<TestEntity>>();
			mockLeftSpecification.Setup(s => s.Evaluate())
